...
uint32_t udm::Property::GetStringSizeRequirement(const String &str) { return GetStringPrefixSizeRequirement(str) + str.length(); }
...
void udm::Property::Write(IFile &f, const Reference &ref) { Write(f, ref.path); }
