...
udm::LinkedPropertyWrapper udm::LinkedPropertyWrapper::operator[](std::string_view key) const { return PropertyWrapper::operator[](key); }
udm::LinkedPropertyWrapper udm::LinkedPropertyWrapper::operator[](const char *key) const { return operator[](std::string_view {key}); }
