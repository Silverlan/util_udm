...
struct BaseUdmData
{
	BaseUdmData(const std::shared_ptr<udm::Data> &udmData,bool clearDataOnDestruction)
		: data{udmData},clearDataOnDestruction{clearDataOnDestruction}
	{}
	~BaseUdmData()
	{
		FreeMemory();
...
struct BaseProperty
{
	BaseProperty(BaseUdmData &data,udm::LinkedPropertyWrapper prop)
		: data{data},prop{prop}
	{}
	BaseUdmData &data;
...
extern "C" {
	...
	DLLUDM bool udm_is_property_valid(UdmProperty prop,const char *path)
	{
