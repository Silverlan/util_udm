...
template<typename T>
udm::ArrayIterator<T>::ArrayIterator() : m_curProperty {}
{
}

template<typename T>
udm::ArrayIterator<T>::ArrayIterator(udm::Array &a, uint32_t idx) : m_curProperty {a, idx}
{
}

template<typename T>
udm::ArrayIterator<T>::ArrayIterator(udm::Array &a) : ArrayIterator {a, 0u}
{
}

template<typename T>
udm::ArrayIterator<T>::ArrayIterator(const ArrayIterator &other) : m_curProperty {other.m_curProperty}
{
}
